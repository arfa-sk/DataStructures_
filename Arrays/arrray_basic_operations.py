class Array:
    ...
    def insert(self, value, position=None):
        ...
        self.print_array()  # Print the array after insertion
    ...
    def delete(self, position):
        ...
        if 0 <= position < len(self.arr):
            ...
            print(f"Invalid position: {position}.")
        self.print_array()  # Print the array after deletion
    ...
    def search(self, value):
        ...
        self.print_array()  # Print the array after searching (to confirm no changes)
    ...
    def traverse(self):
        ...
        self.print_array()  # Print the array after traversal

    def print_array(self):
        """Helper function to print the full array."""
